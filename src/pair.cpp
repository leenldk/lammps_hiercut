...
void Pair::init()
{
  ...
  if (p_fhcut < 0.0f && fhcut_value > 0.0f) {
    p_fhcut = fhcut_value / cutforce;
  }
  else if (fhcut_value < 0.0f && p_fhcut > 0.0f) {
    fhcut_value = p_fhcut * cutforce;
  }
  printf("initialize p_fhcut to: %f, fhcut_value to %f\n", p_fhcut, fhcut_value);
