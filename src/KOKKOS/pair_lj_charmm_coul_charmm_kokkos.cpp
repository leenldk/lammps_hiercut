...
void PairLJCharmmCoulCharmmKokkos<DeviceType>::compute(int eflag_in, int vflag_in)
{
  ...
  qqrd2e_h = __double2half(qqrd2e);
  cut_ljsq_h = __double2half(cut_ljsq);
  cut_lj_innersq_h = __double2half(cut_lj_innersq);
  denom_lj_h = __double2half(denom_lj);
  cut_coulsq_h = __double2half(cut_coulsq);
  cut_coul_innersq_h = __double2half(cut_coul_innersq);
  denom_coul_h = __double2half(denom_coul);
  ...
  // printf("in PairLJCharmmCoulCharmmKokkos::compute\n");
  EV_FLOAT ev;
  // ncoultablebits != 0
  if (this->prec_type == DEFAULT_PREC) {
    if (ncoultablebits)
      ev = pair_compute<PairLJCharmmCoulCharmmKokkos<DeviceType>,CoulLongTable<1> >(this,(NeighListKokkos<DeviceType>*)list);
    else
      ev = pair_compute<PairLJCharmmCoulCharmmKokkos<DeviceType>,CoulLongTable<0> >(this,(NeighListKokkos<DeviceType>*)list);
  }
  else if (this->prec_type == DOUBLE_PREC) {
    ev = RhodoKernels::pair_compute_custom<PairLJCharmmCoulCharmmKokkos<DeviceType>, DOUBLE_PREC, CoulLongTable<1> >(this,(NeighListKokkos<DeviceType>*)list);
  }
  else if (this->prec_type == FLOAT_PREC) {
    ev = RhodoKernels::pair_compute_custom<PairLJCharmmCoulCharmmKokkos<DeviceType>, FLOAT_PREC, CoulLongTable<1> >(this,(NeighListKokkos<DeviceType>*)list);
  }
  else if (this->prec_type == HALF_PREC) {
    ev = RhodoKernels::pair_compute_custom<PairLJCharmmCoulCharmmKokkos<DeviceType>, HALF_PREC, CoulLongTable<1> >(this,(NeighListKokkos<DeviceType>*)list);
  }
  else if (this->prec_type == HFMIX_PREC) {
    ev = RhodoKernels::pair_compute_custom<PairLJCharmmCoulCharmmKokkos<DeviceType>, HFMIX_PREC, CoulLongTable<1> >(this,(NeighListKokkos<DeviceType>*)list);
  }
  else if (this->prec_type == DFMIX_PREC) {
    ev = RhodoKernels::pair_compute_custom<PairLJCharmmCoulCharmmKokkos<DeviceType>, DFMIX_PREC, CoulLongTable<1> >(this,(NeighListKokkos<DeviceType>*)list);
  }
  else {
