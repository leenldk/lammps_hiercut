...
// enum for different float and half precision neighbor separation strategies for half2 calculations
enum NEIGH_SEP_STRATEGY {
  // do not separation different precision neighbor
  NO_NEIGH_SEP = 0,
...
enum NEIGH_REORDER_STRATEGY {
  // do not reorder neighbor list
  NO_NEIGH_REORDER = 0,
  // perform neighbor reoder on neighbor build
  ON_NEIGH_BUILD,
  // perform neighbor reoder on Atom::sort() operation
  ON_ATOM_SORT,
};
